...
sudo echo "exec /usr/local/bin/jupyterhub --port 443 --ssl-key /tensorflow/mykey.key --ssl-cert /tensorflow/mycert.pem" > /etc/init/jupyterhub
sudo chmod +x /etc/init/jupyterhub
