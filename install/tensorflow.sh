...
sudo /usr/local/bin/pip install jupyter notebook boto jupyterhub keras pandas tqdm mxnet six cloudpickle gensim nltk numpy scikit-learn xgboost xgbmagic luigi ipyparallel
