...
sudo /usr/local/bin/pip install jupyter notebook jupyterhub keras pandas mxnet gym[all] six cloudpickle gensim nltk numpy scikit-learn xgboost xgbmagic luigi ipyparallel
